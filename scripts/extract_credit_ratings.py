...
--------------------------
Extracts credit rating data from SEC 10-K filings and loads into filing_metrics.
...
Pipeline:
  ...
  Step 4: Insert verified results into filing_metrics table (source='credit_rating')
...
def insert_credit_rating_to_db(
    ...
    """
    Insert credit rating(s) into filing_metrics table.
