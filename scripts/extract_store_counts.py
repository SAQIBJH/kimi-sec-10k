...
-----------------------
Extracts store/location counts from SEC 10-K filings and loads into filing_metrics.
...
Pipeline:
  ...
  Step 4: Insert verified results into filing_metrics table (source='store_count')

Results are inserted into filing_metrics with:
  - source          = 'store_count'
...
# ══════════════════════════════════════════════════════════════════════════
#  STEP 4: Insert into DB (filing_metrics table)
# ══════════════════════════════════════════════════════════════════════════
...
def insert_store_count_to_db(
    ...
    """
    Insert store count into filing_metrics table.
